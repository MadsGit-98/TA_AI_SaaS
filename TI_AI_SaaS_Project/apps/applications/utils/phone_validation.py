...
def format_phone_for_display(phone: str) -> str:
    ...
    Parses the provided phone string and returns it formatted using the INTERNATIONAL style. If parsing fails, the original input is returned unchanged.
    
    Parameters:
        phone (str): Phone number string (typically E.164 or another international representation).
    
    Returns:
        str: Phone number formatted in international format (e.g., '+1 202-555-1234'), or the original `phone` if parsing fails.
    """
    try:
