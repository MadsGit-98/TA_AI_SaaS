...
urlpatterns = [
    ...
    path('auth/password/reset/confirm/', api.password_reset_confirm, name='password_reset_confirm'),
    path('auth/users/me/', api.get_user_profile, name='get_user_profile'),
    path('auth/users/me/', api.update_user_profile, name='update_user_profile'),
