...
urlpatterns = [
    ...
    # Updated to use UUID for password reset
    ...
    path('auth/users/<uuid:uuid>/', api.user_detail, name='user_detail'),
    path('auth/users/slug/<str:slug>/', api.user_by_slug, name='user_by_slug'),
    ...
    # Updated to use UUID for account activation
